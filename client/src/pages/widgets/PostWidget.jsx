...
import { selectIsToken, selectLoggedInUserId } from '../../redux/selectors';
...
const PostWidget = ({
  ...
  const likeCount = Object.keys(likes).length; //this is grabs the number of likes;
  const { palette } = useTheme();
  const primary = palette.primary.main;
  const main = palette.neutral.main;

  //this function changes number of likes
